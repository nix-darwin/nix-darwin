{ config, lib, ... }:
let
  # Maps string and boolean values to macOS integers
  mkApply =
    mapping: default: v:
    if v == null then
      null
    else
      mapping.${if builtins.isBool v then lib.boolToString v else toString v} or default;
  ...
  options.system.defaults.controlcenter = {
    ...
    AirplayReceiverEnabled = mkOpt {
      ...
      description = ''
        ...
        Corresponds to: System Settings > General > AirDrop & Continuity > AirPlay > AirPlay Receiver
      '';
    };
    ...
    TimeMachine = mkOpt {
      ...
      description = ''
        ...
        Corresponds to: System Settings > Control Center > Time Machine
      '';
    };
    ...
    Weather = mkOpt {
      ...
      description = ''
        ...
        Corresponds to: System Settings > Control Center > Weather
      '';
    };
