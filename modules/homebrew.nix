        ...
        in
        {
          brewfileLine =
            ...
            + optionalString (sCfg ? restart_service) (
              ", restart_service: "
              + (if isBool config.restart_service then sCfg.restart_service else ":${config.restart_service}")
            );
        };
    };
...

{
  ...
  config = {
    ...
    assertions = [
      ...
      {
        assertion = cfg.global.noLock == null;
        message = "The option `homebrew.global.noLock' was removed, use `homebrew.global.lockfiles' in it's place.";
      }
    ];
    ...
    homebrew.brews = optional (cfg.whalebrews != [ ]) "whalebrew";
